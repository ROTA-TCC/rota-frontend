...
const INACTIVE_DOT_COLOR = '#555555';
        ...
        <Defs>
          {selectedLevel === 'intermediate' && (
            <LinearGradient id="arcGradient" x1="50" y1="0" x2="270" y2="0" gradientUnits="userSpaceOnUse">
              ...
              <Stop offset="10%" stopColor="#7A3A10" />
              <Stop offset="30%" stopColor="#C25600" />
          ...
          {selectedLevel === 'advanced' && (
            <LinearGradient id="arcGradient" x1="50" y1="0" x2="270" y2="0" gradientUnits="userSpaceOnUse">
              <Stop offset="0%" stopColor={INACTIVE_DOT_COLOR} />
              <Stop offset="8%" stopColor="#7A3A10" />
              <Stop offset="35%" stopColor="#A84200" />
              <Stop offset="70%" stopColor="#D66200" />
              <Stop offset="100%" stopColor={accentColor} />
            </LinearGradient>
          )}
